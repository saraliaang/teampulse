...
import { faUserGroup, faCircleExclamation, faArrowUp, faArrowDown,faTemperatureLow,faBriefcase } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className='card'>
            <div className='card-left'>
                ...
                <span className='card-number-row'>
                    <span className='card-nunmber'>{number}</span>
                    {changeIndicator && (
                        <span className='card-indicator-icon'>
                            {changeIndicator === 'up' && (
                                <CardIcon icon={faArrowUp} size='sm' color='#6FA876' />
                            )}
                            {changeIndicator === 'down' && (
                                <CardIcon icon={faArrowDown} size='sm' color='#C97A7A' />
                            )}
                        </span>
                    )}
                </span><br />
